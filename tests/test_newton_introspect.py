...
class TestPrivateGuard:
    def test_private_module_name_rejected(self):
        from sim_plugin_newton.introspect import assert_public, PrivateModuleError

        with pytest.raises(PrivateModuleError):
            assert_public("newton._src.internal")

    def test_private_in_describe(self):
        from sim_plugin_newton.introspect import describe_symbol, PrivateModuleError
...
class TestListSymbols:
    def test_top_level_newton_has_symbols(self):
        from sim_plugin_newton.introspect import list_symbols
    ...
    def test_unknown_module_rejected(self):
        from sim_plugin_newton.introspect import list_symbols, PrivateModuleError
...
class TestDescribeSymbol:
    def test_describe_model_builder(self):
        from sim_plugin_newton.introspect import describe_symbol
