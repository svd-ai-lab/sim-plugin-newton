...
hatchling picks it up via ``packages = ["src/sim_plugin_newton"]``
...
def test_wheel_contains_skills(tmp_path: Path) -> None:
    ...
    wheels = list(out_dir.glob("sim_plugin_newton-*.whl"))
    ...
    required = {
        "sim_plugin_newton/__init__.py",
        "sim_plugin_newton/driver.py",
        "sim_plugin_newton/_skills/newton/SKILL.md",
    }
