...
class TestSchemaCheck:
    def test_accepts_new_schema(self):
        _skip_if_missing()
        from sim_plugin_newton.recipes import _execute_recipe_on_builder
        import newton
    ...
    def test_rejects_wrong_schema(self):
        _skip_if_missing()
        from sim_plugin_newton.recipes import _execute_recipe_on_builder, RecipeError
        import newton
...
class TestJsonParsing:
    def test_bad_json_raises(self, tmp_path):
        _skip_if_missing()
        from sim_plugin_newton.recipes import build_model_from_recipe
        p = tmp_path / "r.json"
